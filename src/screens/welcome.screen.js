...
//         <TouchableOpacity key={"Login"} onPress={() => navigation.navigate("Login")} style={styles.button}>
//           <Text style={styles.buttonText}>Login</Text>
//         </TouchableOpacity>
//       </View>
//       <View style={styles.buttonPadding}>
//         <TouchableOpacity key={"Create Account"} onPress={() => navigation.navigate("Create Account")} style={styles.button}>
